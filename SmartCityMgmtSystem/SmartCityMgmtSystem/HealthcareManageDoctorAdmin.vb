...
Public Class HealthcareManageDoctorAdmin
    ...
    Private Sub ShowEditOption(ByVal txt6 As String, ByVal txt3 As String, ByVal txt2 As String, ByVal txt1 As String, ByVal txt7 As String, ByVal txt5 As String, ByVal txt4 As String)
        Label3.Text = "Update Doctor Information"
        Button1.Text = "Update"
        TextBox6.Text = txt6
        TextBox3.Text = txt3
        TextBox2.Text = txt2
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        ElseIf e.ColumnIndex = DataGridView1.Columns("DeleteBut").Index AndAlso e.RowIndex >= 0 Then
            ...
            If result = DialogResult.Yes Then
                ...
                Dim success As Boolean = Globals.ExecuteDeleteQuery("DELETE FROM doctordb where doctor_id = " & DataGridView1.Rows(e.RowIndex).Cells(0).Value)
    ...
    Private Sub LoadandBindDataGridView()
        ...
        cmd = New MySqlCommand("SELECT * FROM doctordb", Con)
        ...
        DataGridView1.Columns(0).DataPropertyName = "doctor_id"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Label3.Text = "Add Doctor Information"
        Button1.Text = "Add"
        TextBox1.Clear()
        TextBox2.Clear()
        TextBox3.Clear()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Button1.Text = "Update" Then
            Dim cmd As String
            cmd = "UPDATE doctordb SET doctor_id = " & Convert.ToInt32(TextBox6.Text) & " , hospital_id =" & Convert.ToInt32(TextBox3.Text) & " , department_id = " & Convert.ToInt32(TextBox2.Text) & ", name = '" & TextBox1.Text & "', phone_number = '" & TextBox7.Text & "', age = " & Convert.ToInt32(TextBox5.Text) & ", gender = '" & TextBox4.Text & "' WHERE doctor_id =" & primaryKeyEdit
        ...
        Else
            Dim cmd As String
            cmd = "INSERT into doctordb(doctor_id,hospital_id,department_id,name,phone_number,age,gender) VALUES (" & Convert.ToInt32(TextBox6.Text) & "," & Convert.ToInt32(TextBox3.Text) & "," & Convert.ToInt32(TextBox2.Text) & ",'" & TextBox1.Text & "','" & TextBox7.Text & "'," & Convert.ToInt32(TextBox5.Text) & ",'" & TextBox4.Text & "')"
